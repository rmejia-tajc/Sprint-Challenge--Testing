...
- describe() us lets organize test into groups - it describes the group. it() lets us describe the test.

1. What is the point of `Test Driven Development`? What do you think about this approach?

- You write your test first then you write code that can be verified by your test. It is a very different way of thinking since it feels like playing jeopardy - going about it backwards.

1. Mention three types of automated tests.

- Unit, component, and snapshot.
